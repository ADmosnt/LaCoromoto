  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <h2 className="font-display text-2xl font-bold text-ink tracking-tight">Orden #{orden.numero_orden}</h2>
        ...
        <div className="ml-auto flex gap-2">
          ...
          <button onClick={handlePDF} className="bg-brand-600 hover:bg-brand-700 text-white text-sm px-4 py-2 rounded-md">
            Descargar PDF
          </button>
        </div>
      </div>
